...
<div class="blog__item">
    ...
    <div class="blog__item__text">
        ...
        <?php if($post->post_type == 'product'): ?>
            <ul>
                <li><strong>Giá gốc: </strong><span><?=  get_post_meta($post->ID, 'product_price', true);  ?></span></li>
                <li><strong>Giá Khuyến mãi:</strong><span><?=  get_post_meta($post->ID, 'product_price_sale', true);  ?></li>
            </ul>
        <?php endif; ?>
